...
# milvus 连接，以及测试用collection
MILVUS_URI = os.getenv("MILVUS_URI", "http://localhost:19530")
MILVUS_COLLECTION = "langchain_rag_system"
...
def get_embeddings():
    ...
    try:
        ...
        print("📊 使用 huggingface Embeddings")
...
class DocumentProcessor:
    ...
    # 创建向量存储
    def create_vector_store(self, documents: List[Document]) -> SimpleMilvusStore:
        """创建向量存储"""
        ...
        try:
            ...
            return SimpleMilvusStore(client, MILVUS_COLLECTION, self.embeddings)
    ...
    def process(self, texts: List[str], metadatas: Optional[List[Dict]] = None) -> SimpleMilvusStore:
        """完整处理流程：加载 -> 分块 -> 向量化"""
        print("📄 加载文档...")
...
class Generator:
    ...
    def __init__(self, config: RAGConfig):
        ...
        self.rag_prompt = ChatPromptTemplate.from_messages([
            ("system",
             """你是一个专业的问答助手。请基于提供的上下文信息回答用户的问题。
             重要规则：
             1. 只使用提供的上下文信息来回答问题
